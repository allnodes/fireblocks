 ...
 *
 */
export const stakingAbi: AbiItem[] = [
  {
    anonymous: false,
    inputs: [
      ...
      { indexed: false, internalType: 'uint256', name: 'effectiveAllocation', type: 'uint256' },
      { indexed: false, internalType: 'address', name: 'sender', type: 'address' },
      { indexed: false, internalType: 'bytes32', name: 'poi', type: 'bytes32' },
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: true, internalType: 'address', name: 'assetHolder', type: 'address' },
  ...
  },
  {
    ...
    inputs: [
      { indexed: true, internalType: 'address', name: 'indexer', type: 'address' },
      { indexed: false, internalType: 'uint32', name: 'indexingRewardCut', type: 'uint32' },
      { indexed: false, internalType: 'uint32', name: 'queryFeeCut', type: 'uint32' },
      { indexed: false, internalType: 'uint32', name: 'cooldownBlocks', type: 'uint32' },
    ],
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: 'uint256', name: 'tokens', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: 'unclaimedAllocationsCount', type: 'uint256' },
  ...
  {
    inputs: [
      { internalType: 'bytes32', name: '_subgraphDeploymentID', type: 'bytes32' },
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: 'uint256', name: 'effectiveAllocation', type: 'uint256' },
  ...
  },
  {
    inputs: [
      { internalType: 'address', name: '_allocationID', type: 'address' },
      { internalType: 'bytes32', name: '_poi', type: 'bytes32' },
    ],
    ...
    inputs: [
      {
        components: [
          ...
          { internalType: 'bytes32', name: 'poi', type: 'bytes32' },
        ],
  ...
  {
    inputs: [
      { internalType: 'address', name: '_closingAllocationID', type: 'address' },
      { internalType: 'bytes32', name: '_poi', type: 'bytes32' },
      { internalType: 'address', name: '_indexer', type: 'address' },
      { internalType: 'bytes32', name: '_subgraphDeploymentID', type: 'bytes32' },
      { internalType: 'uint256', name: '_tokens', type: 'uint256' },
  ...
  },
  {
    ...
    outputs: [{ internalType: 'enum IStaking.AllocationState', name: '', type: 'uint8' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'uint256', name: '_minimumIndexerStake', type: 'uint256' },
      { internalType: 'uint32', name: '_thawingPeriod', type: 'uint32' },
      { internalType: 'uint32', name: '_protocolPercentage', type: 'uint32' },
      { internalType: 'uint32', name: '_curationPercentage', type: 'uint32' },
      { internalType: 'uint32', name: '_channelDisputeEpochs', type: 'uint32' },
      { internalType: 'uint32', name: '_maxAllocationEpochs', type: 'uint32' },
      { internalType: 'uint32', name: '_delegationUnbondingPeriod', type: 'uint32' },
      { internalType: 'uint32', name: '_delegationRatio', type: 'uint32' },
      { internalType: 'uint32', name: '_rebateAlphaNumerator', type: 'uint32' },
      { internalType: 'uint32', name: '_rebateAlphaDenominator', type: 'uint32' },
    ],
    name: 'initialize',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  {
    inputs: [
      { internalType: 'address', name: '_assetHolder', type: 'address' },
  ...
  {
    inputs: [{ internalType: 'uint32', name: '_channelDisputeEpochs', type: 'uint32' }],
  ...
  {
    inputs: [
      { internalType: 'uint32', name: '_indexingRewardCut', type: 'uint32' },
      { internalType: 'uint32', name: '_queryFeeCut', type: 'uint32' },
  ...
  {
    inputs: [{ internalType: 'uint32', name: '_delegationUnbondingPeriod', type: 'uint32' }],
  ...
  {
    inputs: [{ internalType: 'uint32', name: '_maxAllocationEpochs', type: 'uint32' }],
  ...
  {
    inputs: [{ internalType: 'uint256', name: '_minimumIndexerStake', type: 'uint256' }],
  ...
  {
    inputs: [
      { internalType: 'uint32', name: '_alphaNumerator', type: 'uint32' },
      { internalType: 'uint32', name: '_alphaDenominator', type: 'uint32' },
    ],
    name: 'setRebateRatio',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  {
    inputs: [{ internalType: 'uint32', name: '_thawingPeriod', type: 'uint32' }],
  ...
  { inputs: [], name: 'syncAllContracts', outputs: [], stateMutability: 'nonpayable', type: 'function' },
  {
    inputs: [],
    name: 'thawingPeriod',
    outputs: [{ internalType: 'uint32', name: '', type: 'uint32' }],
  ...
  { inputs: [], name: 'withdraw', outputs: [], stateMutability: 'nonpayable', type: 'function' },
  {
    inputs: [
      { internalType: 'address', name: '_indexer', type: 'address' },
      { internalType: 'address', name: '_delegateToIndexer', type: 'address' },
    ],
